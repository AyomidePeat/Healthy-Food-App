...
class FoodInfoScreen extends StatefulWidget {
  final recipes;
  final recipeTag;
  const FoodInfoScreen({@required this.recipes, this.recipeTag, key});
...
class _FoodInfoScreenState extends State<FoodInfoScreen> {
  ...
  Widget build(BuildContext context) {
    Cart cartItem = Cart(
      ...
      imageUrl: widget.recipes.images,
      rating: widget.recipes.rating.toString(),
    );
    return Scaffold(
        // title:
        body:
        ...
        children: [
          ...
          Align(
            ...
            child: Container(
              ...
              child: Padding(
                padding:
                    const EdgeInsets.symmetric(horizontal: 28.0, vertical: 58),
                          ...
                          children: [
                            ...
                            Padding(
                                ...
                                child: ExpandableText(
                                    ...
                                    onLinkPressed: (bool readmore) {
                                  setState(() {
                                    textRead = readmore;
                                  });
                                },
                                    readLessText: "Show less",
                                    linkTextStyle: TextStyle(color: greenColor),
