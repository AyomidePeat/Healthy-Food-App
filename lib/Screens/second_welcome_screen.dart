...
import 'package:healthfooddelivery/Screens/third_welcome_screen.dart';
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                //Container(height: 10, width:15,decoration: BoxDecoration( color:Color.fromARGB(255, 201, 199, 199), borderRadius:BorderRadius.circular(50))),
                const SizedBox(width: 5),
                const Icon(Icons.rectangle_rounded, color: greenColor, size: 8),
                //Container(height: 10, width:5,decoration: BoxDecoration( color:greenColor, borderRadius:BorderRadius.circular(30))),
                const SizedBox(width: 5),
                const Icon(Icons.circle,
                    color: Color.fromARGB(255, 201, 199, 199), size: 5),
                // Container(height: 10, width:7,decoration: BoxDecoration( color:Color.fromARGB(255, 201, 199, 199), borderRadius:BorderRadius.circular(50))),
              ],
            ),
            const SizedBox(height: 15),
            ClickButtons(
